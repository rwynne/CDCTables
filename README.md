# CDCTables [![Build Status](https://travis-ci.org/rwynne/CDCTables.svg?branch=master)](https://travis-ci.org/rwynne/CDCTables)[![codecov](https://codecov.io/gh/rwynne/CDCTables/branch/master/graph/badge.svg)](https://codecov.io/gh/rwynne/CDCTables)
