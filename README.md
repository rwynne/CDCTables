# CDCTables [![Build Status](https://travis-ci.org/rwynne/CDCTables.svg?branch=master)] [![codecov](https://codecov.io/gh/rwynne/CDCTables/branch/master/graph/badge.svg)](https://codecov.io/gh/rwynne/CDCTables)
